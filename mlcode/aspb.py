...
if __name__ == '__main__':
    download_aspb(sleep=10., mx=5, journal='1040-4651')
    # download_aspb(sleep=10., mx=5, journal='0032-0889')
    # download_aspb(sleep=10., mx=5, journal='1532-298X') # web issn for the plant cell
